$(function(){
	...
	$(window).resize(function(){
		...
		if(isMobile) {
			if(w > h) {
				$("#p1_content, #page2, #page3, #page4, #footer, #mobile_menu").addClass("mobile");	
			}
			else {
				$("#p1_content, #page2, #page3, #page4, #footer, #mobile_menu").removeClass("mobile");
			}
		}
	...
	$("#menu").click(function(e){
		...
		$("#header .fixed_arrow.fixed").toggleClass("on");
	});
